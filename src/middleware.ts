...
export default async function middleware(request: NextRequest) {
    ...
    const cspDirectives = [
        ...
        "img-src 'self' data: blob: https://*.supabase.co https://*.supabase.in https://lh3.googleusercontent.com https://api.dicebear.com https://ui-avatars.com https://image.pollinations.ai https://images.unsplash.com https://cdn.pixabay.com",
        ...
        "media-src 'self' data: blob: https://cdn.pixabay.com",
        "frame-src 'self'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
